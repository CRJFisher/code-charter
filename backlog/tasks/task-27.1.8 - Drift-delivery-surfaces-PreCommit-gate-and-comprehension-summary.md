...
2. **PreCommit gate:** the `code-charter drift gate --staged` CLI predicate consuming the task-27.1.7 classification + task-27.1.5 state, scoped to `git diff --cached`; `--no-verify` bypass.
