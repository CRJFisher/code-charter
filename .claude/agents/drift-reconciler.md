...
2. The skill owns all store-mutation logic. You do NOT write the store yourself, you do NOT call
   any MCP `drift.*` tool, and you do NOT inspect or summarize diagram internals.
