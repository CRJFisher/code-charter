      ...
      entrypoints: [
        {
          ...
          line: 2,
          is_orphan: true,
          members: [{ name: "handle_create", kind: "function" }],
        ...
        },
        {
          ...
          line: 2,
          is_orphan: true,
          members: [{ name: "handle_delete", kind: "function" }],
          described_coverage: { docstring: 0, provisional: 1, placeholder: 0, llm: 0 },
          unresolved_sites: [],
        },
        {
          ...
          members: [
            ...
            { name: "lookup_handler", kind: "function" },
          ],
      ...
      entrypoints: [
        {
          ...
          members: [
            ...
            { name: "run_scheduled", kind: "function" },
          ],
          described_coverage: { docstring: 0, provisional: 2, placeholder: 0, llm: 0 },
      ...
      entrypoints: [
        {
          ...
          line: 4,
          is_orphan: true,
          members: [{ name: "export_rows", kind: "method" }],
          described_coverage: { docstring: 0, provisional: 1, placeholder: 0, llm: 0 },
          unresolved_sites: [],
        },
        {
          ...
          is_orphan: true,
          members: [
            { name: "run_export", kind: "function" },
            { name: "export_report", kind: "function" },
          ],
          described_coverage: { docstring: 0, provisional: 2, placeholder: 0, llm: 0 },
          unresolved_sites: [],
        },
      ...
      entrypoints: [
        {
          ...
          line: 3,
          is_orphan: true,
          members: [{ name: "summarize", kind: "function" }],
          described_coverage: { docstring: 0, provisional: 1, placeholder: 0, llm: 0 },
          unresolved_sites: [],
        },
      ],
      ...
      entrypoints: [
        {
          ...
          line: 1,
          is_orphan: true,
          members: [{ name: "clamp_percent", kind: "function" }],
          described_coverage: { docstring: 0, provisional: 1, placeholder: 0, llm: 0 },
          unresolved_sites: [],
        },
        {
          ...
          line: 10,
          is_orphan: true,
          members: [{ name: "to_fahrenheit", kind: "function" }],
          described_coverage: { docstring: 0, provisional: 1, placeholder: 0, llm: 0 },
          unresolved_sites: [],
        },
      ],
