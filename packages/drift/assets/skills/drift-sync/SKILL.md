...
description: >-
  ...
  its code is worked on, or re-sync an existing flow. Invoked by the drift-reconciler sub-agent with
  the files worked on this turn. It always updates the diagram and never asks permission; agentic
  content is regenerated each sync.
allowed-tools: Bash
---
